...
@register_model('adsbrain_roberta')
class AdsbrainRobertaModel(FairseqLanguageModel):
...
class RobertaEncoder(FairseqDecoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.position_head = RobertaLMHead(
            embed_dim=args.encoder_embed_dim,
    ...
    def output_position_layer(self, features, masked_positions=None, **unused):
        return self.position_head(features, masked_positions)
...
@register_model_architecture('adsbrain_roberta', 'adsbrain_roberta')
...
@register_model_architecture('adsbrain_roberta', 'adsbrain_roberta_large')
...
@register_model_architecture('adsbrain_roberta', 'adsbrain_xlm')
